...
class UpdateEmployeeJobProfileTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'people.employee_job_profiles.PATCH';
    }

    public function getDescription(): string
    {
        return 'PATCH /people/employee-job-profiles/{id} - Aktualisiert eine Mitarbeiter-JobProfile-Zuweisung.';
    }
    ...
    public function getSchema(): array
    {
        return $this->mergeWriteSchema([
            'properties' => [
                ...
                'context_entity_id'         => ['type' => 'integer', 'description' => 'Optional: Linie/Carrier (weiche Organization-Referenz). 0/null = Bezug entfernen.'],
    ...
    public function getMetadata(): array
    {
        return [
            'category'      => 'action',
            'tags'          => ['people', 'employee_job_profiles', 'update'],
            'read_only'     => false,
            'requires_auth' => true,
            'requires_team' => true,
            'risk_level'    => 'write',

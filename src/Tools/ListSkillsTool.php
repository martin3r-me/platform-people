...
class ListSkillsTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'people.skills.GET';
    }

    public function getDescription(): string
    {
        return 'GET /people/skills - Listet den Skill-Katalog (technische, methodische, fachliche, soziale Skills) des Teams. Unterstützt filters/search/sort/limit/offset.';
    }
        ...
        return $this->mergeSchemas(
            ...
            [
                'properties' => [
                    ...
                    'category' => [
                        'type' => 'string',
                        'description' => 'Optional: Filter nach Kategorie (technical/methodical/domain/social).',
                    ],
                    'is_active' => [
                        'type' => 'boolean',
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        try {
            ...
            $items = $result['data']->map(fn ($skill) => [
                ...
                'usage_count' => $skill->employeeSkills()->count(),
            ])->values()->toArray();

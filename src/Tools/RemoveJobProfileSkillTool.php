...
class RemoveJobProfileSkillTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'people.job_profile_skills.DELETE';
    }

    public function getDescription(): string
    {
        return 'DELETE /people/job-profile-skills - Entfernt einen Skill von einem JobProfile.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        try {
            ...
            $jp->skillRecords()->detach($skillId);
    ...
    public function getMetadata(): array
    {
        return [
            'category'      => 'action',
            'tags'          => ['people', 'job_profiles', 'skills', 'delete'],
            'read_only'     => false,
            'requires_auth' => true,
            'requires_team' => true,
            'risk_level'    => 'write',

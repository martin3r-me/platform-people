...
class ListJobProfileRolesTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'people.job_profile_roles.GET';
    }

    public function getDescription(): string
    {
        return 'GET /people/job-profile-roles?job_profile_id=X - Listet die Rollen-Verteilung eines JobProfiles mit Anteil und VSM-System. Rollen sind Organization-Rollen (weiche Referenz).';
    }
    ...
    public function getMetadata(): array
    {
        return [
            'category' => 'read',
            'tags' => ['people', 'job_profiles', 'roles'],
            'read_only' => true,
            'requires_auth' => true,
            'requires_team' => true,
            'risk_level' => 'safe',

...
class CreateJobProfileTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'people.job_profiles.POST';
    }

    public function getDescription(): string
    {
        return 'POST /people/job-profiles - Erstellt ein JobProfile (wiederverwendbares Stellenprofil-Template) im Root/Elterteam.';
    }
    ...
    public function getSchema(): array
    {
        return [
            ...
            'properties' => [
                ...
                'exclusion_criteria' => ['type' => 'array', 'description' => 'Optional: Ausschlusskriterien. Format: ["Keine Influencerin", "Keine Selbstinszenierung"]'],
                'work_model'         => ['type' => 'object', 'description' => 'Optional: Arbeitsmodell. Format: {"type": "remote|hybrid|onsite|travel", "travel_required": bool, "self_organized": bool, "location_notes": "..."}'],
                'reporting'          => ['type' => 'object', 'description' => 'Optional: Reporting-Linie. Format: {"reports_to": "CTO / Entity-Name", "autonomy_level": "full|guided|supervised"}'],
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        try {
            ...
            $jp = JobProfile::create([
                ...
                'exclusion_criteria' => (isset($arguments['exclusion_criteria']) && is_array($arguments['exclusion_criteria'])) ? $arguments['exclusion_criteria'] : null,
                'work_model'         => (isset($arguments['work_model']) && is_array($arguments['work_model'])) ? $arguments['work_model'] : null,
                'reporting'          => (isset($arguments['reporting']) && is_array($arguments['reporting'])) ? $arguments['reporting'] : null,
    ...
    public function getMetadata(): array
    {
        return [
            'category'      => 'action',
            'tags'          => ['people', 'job_profiles', 'create'],
            'read_only'     => false,
            'requires_auth' => true,
            'requires_team' => true,
            'risk_level'    => 'write',
